...
grupo_sprites=pygame.sprite.Group(sprite0,sprite1,sprite2,sprite3,sprite4,sprite5)
...
while rodando: # o loop funciona enquanto a variável rodando for True
    ...
    if pygame.sprite.collide_mask(sprite0, sprite2):
        sprite0.rect.x=1
        sprite0.rect.y=1
        x=1
        y=1
    
    if pygame.sprite.collide_mask(sprite0, sprite3):
        sprite0.rect.x=1
        sprite0.rect.y=1
        x=1
        y=1
    
    if pygame.sprite.collide_mask(sprite0, sprite4):
        sprite0.rect.x=1
        sprite0.rect.y=1
        x=1
        y=1
    
    if pygame.sprite.collide_mask(sprite0, sprite5):
        sprite0.rect.x=1
        sprite0.rect.y=1
        x=1
        y=1
